...
O código pressiona o sistema com carga crescente por meio de múltiplas instâncias (threads) organizadas em fases sequenciais. A cada nova fase, mais threads são somadas ao teste, intensificando gradualmente o volume de requisições enviadas ao endpoint `wp-cron.php`.
